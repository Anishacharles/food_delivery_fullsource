...
//         className={`w-40 py-2 px-4 rounded-lg transition-all duration-300 
//                     ${activeCategory === 'all' ? 'bg-blue-500 text-white' : 'bg-transparent text-gray-700 border-2 border-gray-300 hover:bg-blue-100'}`}
//     >
//         All
//     </button>
//     <button 
...
//         className={`w-40 py-2 px-4 rounded-lg transition-all duration-300 
//                     ${activeCategory === 'south-indian' ? 'bg-blue-500 text-white' : 'bg-transparent text-gray-700 border-2 border-gray-300 hover:bg-blue-100'}`}
//     >
//         South-Indian
//     </button>
//     <button 
...
//         className={`w-40 py-2 px-4 rounded-lg transition-all duration-300 
//                     ${activeCategory === 'north-indian' ? 'bg-blue-500 text-white' : 'bg-transparent text-gray-700 border-2 border-gray-300 hover:bg-blue-100'}`}
//     >
//         North-Indian
//     </button>
//     <button 
...
//         className={`w-40 py-2 px-4 rounded-lg transition-all duration-300 
//                     ${activeCategory === 'chinese' ? 'bg-blue-500 text-white' : 'bg-transparent text-gray-700 border-2 border-gray-300 hover:bg-blue-100'}`}
//     >
//         Chinese
//     </button>
//     <button 
...
//         className={`w-40 py-2 px-4 rounded-lg transition-all duration-300 
//                     ${activeCategory === 'bakery' ? 'bg-blue-500 text-white' : 'bg-transparent text-gray-700 border-2 border-gray-300 hover:bg-blue-100'}`}
//     >
//         Bakery
//     </button>
// </div>

//             <section className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 max-w-screen-xl mx-auto">
